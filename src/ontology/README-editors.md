These notes are for the EDITORS of ecrro
...
Make sure you have an ID range in the [idranges file](ecrro-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [ecrro-edit.owl](ecrro-edit.owl)

** DO NOT EDIT ecrro.obo OR ecrro.owl in the top level directory **

[../../ecrro.owl](../../ecrro.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/earthcubearchitecture-ecresourcereg/ecrro) for details.
 ...
 * [ecrro-idranges.owl](ecrro-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/ecrro_terms.txt file
...
Note: the ecrro_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as ecrro.owl and ecrro.obo and places
 ...
 * https://github.com/earthcubearchitecture-ecresourcereg/ecrro/releases
 * https://github.com/earthcubearchitecture-ecresourcereg/ecrro/releases/new
...
what is in the `owl:versionIRI` of the derived ecrro.owl (`data-version` in
ecrro.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/ecrro.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/ecrro/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/earthcubearchitecture-ecresourcereg/ecrro.svg?branch=master)](https://travis-ci.org/earthcubearchitecture-ecresourcereg/ecrro)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/earthcubearchitecture-ecresourcereg](https://travis-ci.org/profile/earthcubearchitecture-ecresourcereg)
 2. click the "Sync account" button
 3. Click the tick symbol next to ecrro
